...
var NRS = (function (NRS, $, undefined) {
    ...
    NRS.isRsAccount = function(account) {
        return NRS.isRsAccountImpl(account, NRS.constants.ACCOUNT_RS_MATCH ? NRS.constants.ACCOUNT_RS_MATCH : NRS.getRsAccountRegex("CRYT"));
    };
    ...
    NRS.getAccountMask = function(c) {
        switch(c) {
            ...
            default:
                return NRS.constants.ACCOUNT_MASK_PREFIX ? NRS.constants.ACCOUNT_MASK_PREFIX : "CRYT-";
        }
    };
